...
--
-- My changes ("hyprctl reload" to activate settings after changes)
--

--
-- Open the installed ChatGPT desktop app instead of the default web app.
--
hl.unbind("SUPER + SHIFT + A")
o.bind("SUPER + SHIFT + A", "ChatGPT app", { launch = "chatgpt" })

--
--#region Fireblade (https://github.com/data-goblin/fileblade/blob/main/examples/fileblade-bindings.lua)
--
